...
const topics = [
  ["AI a technologie", "Příležitosti, rizika a jak je využít smysluplně.", "/assets/brand/young/scenes/topic-ai.svg"],
  ["Identita a vztahy", "Kdo jsem, kam patřím a jak stavět zdravé vztahy.", "/assets/brand/young/scenes/topic-relationships.svg"],
  ["Společnost a svět", "Co se děje kolem nás a jak to spolu souvisí.", "/assets/brand/young/scenes/topic-society.svg"],
  ["Klima a příroda", "Co lze pozorovat, zkusit a skutečně ovlivnit.", "/assets/brand/young/scenes/topic-climate.svg"],
  ["Smysl a budoucnost", "Kam směřujeme a jaké scénáře chceme tvořit.", "/assets/brand/young/scenes/topic-future.svg"],
  ["Vzdělávání a cesta", "Jak se učit otázkou, pokusem, tvorbou a zkušeností.", "/assets/brand/young/scenes/topic-learning.svg"],
];

const youngStories = [
  ["PŘÍBĚH", "Jak se z prázdného místa stane zahrada?", "Od nápadu přes péči až ke společnému místu.", "/assets/brand/young/scenes/story-city-garden.svg"],
  ["DEBATA", "Kde má AI pomáhat a kde rozhodovat člověk?", "Dva pohledy, zdroje a prostor vytvořit si vlastní názor.", "/assets/brand/young/scenes/story-ai-school.svg"],
  ["MINI SÉRIE", "Od semínka k talíři", "Pěstování, cesta potravin, práce a společné jídlo v souvislostech.", "/assets/brand/young/scenes/story-food-route.svg"],
];

const youngMissionScenes = Object.freeze({
  rostlina:"/assets/brand/young/scenes/mission-grow.svg",
  videohovor:"/assets/brand/young/scenes/mission-video-call.svg",
  jidlo:"/assets/brand/young/scenes/mission-family-cooking.svg",
  puvod:"/assets/brand/young/scenes/mission-food-origin.svg",
  odpad:"/assets/brand/young/scenes/mission-upcycle.svg",
  pomoc:"/assets/brand/young/scenes/mission-safe-help.svg",
});
