...
const SCHOOL_ENTRY=[
 {title:"Projekt",text:"Jedna konkrétní otázka může propojit více předmětů i rolí.",href:"/projekty",image:pansofiePhoto("growing-together-16x9"),label:"UČENÍ V PRAXI"},
 {title:"16 oblastí",text:"Mapa témat od člověka a vztahů po technologie, finance a přírodu.",href:"/16-oblasti",image:pansofiePhoto("curiosity-nature-16x9"),label:"OBSAH"},
 {title:"7 cest",text:"Růst bez veřejného pořadí, osobního skóre nebo jediného správného profilu.",href:"/7-cest",image:pansofiePhoto("prague-nature-16x9"),label:"ROZVOJ"},
 {title:"Okolí školy",text:"Město, příroda, organizace a zkušenost lidí mohou být součástí učení.",href:"/sit",image:pansofieScene("school-life-learning"),label:"KONTEXT"},
];
export default function SchoolsPage(){return <PublicShell active="/pro-skoly" current="/pro-skoly">
 ...
 <section className="pw-community-entry-grid">{SCHOOL_ENTRY.map(card=><Link href={card.href} className="pw-community-entry-card" key={card.title}><div><Image src={card.image} alt="" fill sizes="(max-width:900px) 100vw,25vw"/></div><span>{card.label}</span><h2>{card.title}</h2><p>{card.text}</p></Link>)}</section>
 <EditorialFeatureBand eyebrow="MĚSTO JAKO UČEBNA" title="Děti nepotřebují jen další obrazovku. Potřebují svět kolem sebe." text="Zahrada, dílna, místní firma, knihovna i zkušenost starších lidí mohou být součástí učení. AI pomáhá zkoumat a tvořit, rozhodnutí zůstává na lidech." image={pansofiePhoto("growing-together-16x9")} imageAlt="Mladší a starší lidé spolupracují na praktickém projektu" items={[["Příroda","Půda, voda, pěstování a městská zeleň."],["Materiál","Dřevo, textil a další zbytky mohou dostat druhý život."],["Generace","Rodiče, senioři a odborníci přinášejí zkušenost do bezpečného kontextu."],["Technologie","AI pomáhá zkoumat a tvořit, rozhodnutí zůstává na lidech."]]} link={{href:"/instituce",label:"Propojit školu s okolím"}}/>
