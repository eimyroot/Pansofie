...
export default function VolunteeringPage() {
  return <PublicShell active="/dobrovolnictvi">
    <section className="pw-visual-hero pw-visual-hero--volunteer">
      ...
      <div className="pw-visual-hero__media"><Image src={pansofiePhoto("community-city-16x9")} alt="Lidé společně pracují na komunitním projektu" fill priority sizes="(max-width: 900px) 100vw, 52vw"/><div className="pw-visual-hero__note">malé kroky · skutečný kontext · volitelná reflexe</div></div>
    </section>
