...
const LABS = [
  ["Green Hope", "Příroda, péče a konkrétní místo.", "/green-hope"],
  ["Urban Family Farm", "Pěstování, práce, hodnota a ekonomika.", "/urban-family-farm"],
  ["Digitální kompost", "Materiály, data a druhý život věcí.", "/digitalni-kompost"],
];
...
export default function LabsPage() {
  return <PublicShell active="/labs">
    <section className="pw-visual-hero pw-visual-hero--engine pw-visual-hero--labs">
      ...
      <div className="pw-visual-hero__engine"><PansofieVisualEngine mode="flow" kicker="PANSOFIE LABS" title="Od otázky k ověření" detail="malý pokus · skutečné pozorování" flow={["Otázka","Prototyp","Pozorování","Sdílení"]}/></div>
    </section>
    <section className="pw-visual-card-strip pw-visual-card-strip--three">{LABS.map(([title,text,href]) => <PansofieVisualCard title={title} text={text} href={href} label="LAB" key={title}/>)}</section>
