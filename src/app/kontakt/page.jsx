...
export default function ContactPage(){return <PublicShell active="/kontakt">
 <section className="pw-visual-hero pw-visual-hero--contact"><div className="pw-visual-hero__copy"><p className="pw-eyebrow">KONTAKT</p><h1>Napište nám, co potřebujete.</h1><p>Kontakt slouží pro konkrétní dotazy, spolupráci, přístupnost a bezpečnostní podněty. Formulář je zatím transparentně označený jako lokální prototyp bez připojeného mailboxu.</p><div className="pw-visual-hero__actions"><a className="pw-button pw-button--dark" href="#kontaktni-formular">Přejít k formuláři</a><Link className="pw-button pw-button--light" href="/partnerstvi">Jak chápeme partnerství</Link></div></div><div className="pw-visual-hero__media"><Image src={pansofieScene("contact-growth")} alt="Ilustrace růstu spolupráce" fill priority sizes="(max-width:900px) 100vw,58vw"/><div className="pw-visual-hero__note">dotaz → kontext → další bezpečný krok</div></div></section>
