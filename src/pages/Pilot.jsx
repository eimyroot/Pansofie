...
const EXPERIENCES = [
  ["01", "Zlepši svou školu", "Vlastní iniciativa · místní účast · řešení problému", "Žáci identifikují konkrétní problém ve škole, navrhnou dosažitelnou změnu, provedou malý pilot a doloží, co se skutečně změnilo.", GraduationCap],
  ...
  ["03", "Circular Challenge", "Reálná výzva · zdroje · použití výsledku", "Škola, komunita nebo partner dodá ohraničenou výzvu. Tým změří výchozí stav, vytvoří řešení a oddělí samotný výstup od jeho skutečného použití a dopadu.", Sparkles],
];

const SPINE = ["Příprava školy", "3 Experiences", "Důkaz", "Reflexe", "Ověření učitelem", "Experience Passport", "PANSOFIE DAY", "Vyhodnocení důkazů"];

const ROLES = [
  ["Žák", Sparkles, "Dělá skutečnou činnost, ukládá důkaz a vlastní reflexi. Nemůže si sám ověřit dokončení ani Experience Passport."],
  ["Učitel / koordinátor", GraduationCap, "Přiřazuje mise, kontroluje bezpečný rozsah a odděleně potvrzuje výsledek. Nemění žákovu reflexi."],
  ...
  ["Partner", Handshake, "Může dodat vhodnou výzvu, expertizu a zpětnou vazbu k práci. Nekupuje hodnocení žáka, použití výsledku ani tvrzení o pozitivním dopadu."],
...
const BOUNDARIES = [
  ...
  "Žádné jediné souhrnné skóre člověka; hodnotí se doložená práce a proces.",
  "Partner nemá neomezené soukromé zprávy směrem k dětem.",
  "Účast ve vzdělávání není podmíněná marketingovým souhlasem.",
  "Výstup, jeho použití a skutečný dopad jsou vedené jako rozdílné věci.",
];
      ...
      <main className="pt-28 sm:pt-32">
        <section className="container-px max-w-7xl mx-auto py-12 sm:py-20">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-3xl leading-relaxed">Pilot převádí metodu Pansofie do malého, měřitelného školního provozu: reálná činnost → důkaz → reflexe → oddělené ověření → Experience Passport.</p>
            <p className="mt-4 text-sm sm:text-base text-muted-foreground max-w-3xl leading-relaxed">Digitální školní cesta je funkční a otestovaná. Reálný field pilot ve škole ještě neproběhl — první ověření s reálnou školou je teprve před námi.</p>
