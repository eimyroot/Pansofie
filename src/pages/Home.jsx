    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        <section className="relative overflow-hidden pt-32 pb-20 sm:pt-40 sm:pb-28">
          <div className="absolute inset-0 -z-10" aria-hidden="true"><div className="absolute top-[-140px] left-1/2 -translate-x-1/2 h-[720px] w-[1100px] max-w-[120vw] bg-[radial-gradient(ellipse_at_center,_rgba(16,185,129,0.13),_transparent_62%)]" /></div>
