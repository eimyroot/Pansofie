-- PANSOFIE STAGING ROLE MATRIX R1
-- Staging-only verification. Creates synthetic auth identities, exercises RLS/RPC
-- boundaries and golden-path lifecycle, then removes every fixture row.
...
-- Anonymous callers must have no EXECUTE on governed SECURITY DEFINER functions.
do $$
declare r record;
begin
  for r in
...
values ('50000000-0000-4000-8000-000000000001','fixture-school-r1','PANSOFIE Fixture School','school','active','10000000-0000-4000-8000-000000000001');
...
insert into public.missions (
  ...
  '60000000-0000-4000-8000-000000000001','fixture-circular-r1','Fixture Circular Challenge',
...
select '20000000-0000-4000-8000-000000000001',
       ...
       'public_task','organization','active','fixture-r1','staging verification only'
from unnest(array[
...
insert into public.processing_basis_records (
  ...
  'fixture-r1','guardian','30000000-0000-4000-8000-000000000001','70000000-0000-4000-8000-000000000001',
...
-- Cleanup every fixture row. If an earlier assertion fails, apply_migration is
-- expected to roll the migration transaction back and leave no partial fixture.
reset role;
