...
const app=read("src/App.jsx"),nav=read("src/components/Nav.jsx"),ctx=read("src/state/PansofieContext.jsx"),map=read("src/legacy-pages/CycleMap.jsx"),compost=read("src/legacy-pages/Compost.jsx"),institutions=read("src/legacy-pages/Institutions.jsx"),language=read("src/state/LanguageContext.jsx"),metabolism=read("src/lib/metabolism.js"),profile=read("src/legacy-pages/Profile.jsx");
...
for(const file of ["src/legacy-pages/CycleMap.jsx","src/legacy-pages/PersonalGrowth.jsx","src/legacy-pages/Institutions.jsx","src/legacy-pages/Compost.jsx","src/legacy-pages/Vision.jsx"]){const t=read(file);for(const bad of ["onclick=","alert(","marker._icon","simulateGPS"])if(t.includes(bad))fail(`${file} contains ${bad}`)}
