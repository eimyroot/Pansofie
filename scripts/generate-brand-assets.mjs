...
const paths = {
  body: `<path d="M4 18 9 9l3 4 3-6 5 11Z"/><path d="M7 18h10M12 5v2"/>`,
  mind: `<path d="M4 6.5c2.8-.9 5-.5 8 1.4v10.6c-3-1.9-5.2-2.3-8-1.4z"/><path d="M20 6.5c-2.8-.9-5-.5-8 1.4v10.6c3-1.9 5.2-2.3 8-1.4z"/><path d="M12 7.9v10.6"/>`,
  ...
  relationships: `<path d="M4 18h16M6 18v-5c0-3.5 2.2-6 6-6s6 2.5 6 6v5M6 13h12M9 9.2V18M15 9.2V18"/>`,
  creativity: `<path d="M13 3c1.5 3.2-.7 4.8-.7 7 0 1.3.8 2.3 2 2.3 1.7 0 2.7-1.5 2.5-3.4 1.7 1.9 2.7 4.1 2.7 6.3A7.5 7.5 0 0 1 4.5 15c0-3.5 2-6.7 5.8-9.1-.3 2.7.9 4.2 2 4.2 1.1 0 1.7-1 1.7-2.2 0-1.3-.6-2.7-1-4.9Z"/><path d="M9 19c.8-2.2 1.8-3.5 3-3.5s2.2 1.3 3 3.5"/>`,
  prosperity: `<circle cx="12" cy="12" r="7"/><circle cx="12" cy="12" r="2.4"/><path d="M12 3v2M12 19v2M3 12h2M19 12h2M5.6 5.6 7 7M17 17l1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4"/>`,
  meaning: `<path d="M12 20V9"/><path d="M12 12C8 12 5.5 9.5 5.5 6c4 0 6.5 2.5 6.5 6ZM12 15c4 0 6.5-2.5 6.5-6-4 0-6.5 2.5-6.5 6Z"/><path d="M8 20h8"/>`,
};
