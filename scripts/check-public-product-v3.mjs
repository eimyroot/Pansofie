...
const required = [
  ...
  [files.how, "Jedna Experience vzniká postupně."],
  [files.how, "Dokončená aktivita, použití výsledku a následný dopad jsou tři různé věci a systém je nezaměňuje."],
  [files.how, 'to="/pro-koho"'],
  [files.how, 'to="/pro-koho#ochutnejte"'],
